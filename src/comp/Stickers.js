...
class Stickers extends Component {
	constructor(props){
		super(props);
		this.state={
			myImg:require("../imgs/hello.png"),
			myImg2:require("../imgs/hello2.png"),
			allUsers:[],
			myId: null,
			showDisplay:false,
			stickers:[]
  ...
  render() {
	  ...
	  var allimages = this.state.allUsers.map((obj,i)=>{
		  return (
		  	<img ref={"u"+obj} key={i} height={80} className="allImgs" src={this.state.myImg} />
		  )
	  })
	  ...
	  if(this.state.showDisplay === false){
		  ...
		  />
		   ...
		   comp = (
		  <div>
		  <div ref="thedisplay" className="displayDiv">
				{allimages}
			   	{stickers}
		</div>
